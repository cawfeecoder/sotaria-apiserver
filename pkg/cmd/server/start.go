...
import (
	...
	"github.com/nfrush/sotaria-apiserver/pkg/admission/sotariainitializer"
	"github.com/nfrush/sotaria-apiserver/pkg/apis/sotaria/v1alpha1"
	"github.com/nfrush/sotaria-apiserver/pkg/apiserver"
	clientset "github.com/nfrush/sotaria-apiserver/pkg/generated/clientset/versioned"
	informers "github.com/nfrush/sotaria-apiserver/pkg/generated/informers/externalversions"
	sampleopenapi "github.com/nfrush/sotaria-apiserver/pkg/generated/openapi"
...
const defaultEtcdPathPrefix = "/registry/nfrush.github.com"
...
func NewCommandStartWardleServer(defaults *WardleServerOptions, stopCh <-chan struct{}) *cobra.Command {
	o := *defaults
	cmd := &cobra.Command{
		Short: "Launch a sotaria API server",
		Long:  "Launch a sotaria API server",
...
func (o *WardleServerOptions) Config() (*apiserver.Config, error) {
	...
	o.RecommendedOptions.ExtraAdmissionInitializers = func(c *genericapiserver.RecommendedConfig) ([]admission.PluginInitializer, error) {
		...
		return []admission.PluginInitializer{sotariainitializer.New(informerFactory)}, nil
	}
