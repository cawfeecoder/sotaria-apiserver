...
// SecurityV1alpha1Client is used to interact with features provided by the security.sotaria.us group.
type SecurityV1alpha1Client struct {
	restClient rest.Interface
}

func (c *SecurityV1alpha1Client) Projects(namespace string) ProjectInterface {
