...
import (
	...
	scheme "github.com/nfrush/sotaria-apiserver/pkg/generated/clientset/versioned/scheme"
...
func newProjects(c *SecurityV1alpha1Client, namespace string) *projects {
	return &projects{
		client: c.RESTClient(),
		ns:     namespace,
	}
