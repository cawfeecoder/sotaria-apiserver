...
import (
	...
	sotariav1alpha1 "github.com/nfrush/sotaria-apiserver/pkg/apis/sotaria/v1alpha1"
	...
	v1alpha1 "github.com/nfrush/sotaria-apiserver/pkg/generated/listers/sotaria/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SecurityV1alpha1().Projects(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SecurityV1alpha1().Projects(namespace).Watch(context.TODO(), options)
			},
		},
		&sotariav1alpha1.Project{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *projectInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&sotariav1alpha1.Project{}, f.defaultInformer)
}
