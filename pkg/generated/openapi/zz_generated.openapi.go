...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/nfrush/sotaria-apiserver/pkg/apis/sotaria/v1alpha1.Project":       schema_pkg_apis_sotaria_v1alpha1_Project(ref),
		"github.com/nfrush/sotaria-apiserver/pkg/apis/sotaria/v1alpha1.ProjectList":   schema_pkg_apis_sotaria_v1alpha1_ProjectList(ref),
		"github.com/nfrush/sotaria-apiserver/pkg/apis/sotaria/v1alpha1.ProjectSpec":   schema_pkg_apis_sotaria_v1alpha1_ProjectSpec(ref),
		"github.com/nfrush/sotaria-apiserver/pkg/apis/sotaria/v1alpha1.ProjectStatus": schema_pkg_apis_sotaria_v1alpha1_ProjectStatus(ref),
...
func schema_pkg_apis_sotaria_v1alpha1_Project(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/nfrush/sotaria-apiserver/pkg/apis/sotaria/v1alpha1.ProjectSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/nfrush/sotaria-apiserver/pkg/apis/sotaria/v1alpha1.ProjectStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/nfrush/sotaria-apiserver/pkg/apis/sotaria/v1alpha1.ProjectSpec", "github.com/nfrush/sotaria-apiserver/pkg/apis/sotaria/v1alpha1.ProjectStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_sotaria_v1alpha1_ProjectList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/nfrush/sotaria-apiserver/pkg/apis/sotaria/v1alpha1.Project"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/nfrush/sotaria-apiserver/pkg/apis/sotaria/v1alpha1.Project", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_pkg_apis_sotaria_v1alpha1_ProjectSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_pkg_apis_sotaria_v1alpha1_ProjectStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
