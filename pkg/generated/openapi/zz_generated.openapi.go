...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"k8s.io/sample-apiserver/pkg/apis/sotaria/v1alpha1.Project":       schema_pkg_apis_sotaria_v1alpha1_Project(ref),
		"k8s.io/sample-apiserver/pkg/apis/sotaria/v1alpha1.ProjectList":   schema_pkg_apis_sotaria_v1alpha1_ProjectList(ref),
		"k8s.io/sample-apiserver/pkg/apis/sotaria/v1alpha1.ProjectSpec":   schema_pkg_apis_sotaria_v1alpha1_ProjectSpec(ref),
		"k8s.io/sample-apiserver/pkg/apis/sotaria/v1alpha1.ProjectStatus": schema_pkg_apis_sotaria_v1alpha1_ProjectStatus(ref),
	}
}
...
func schema_pkg_apis_sotaria_v1alpha1_Project(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("k8s.io/sample-apiserver/pkg/apis/sotaria/v1alpha1.ProjectSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("k8s.io/sample-apiserver/pkg/apis/sotaria/v1alpha1.ProjectStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "k8s.io/sample-apiserver/pkg/apis/sotaria/v1alpha1.ProjectSpec", "k8s.io/sample-apiserver/pkg/apis/sotaria/v1alpha1.ProjectStatus"},
	}
}
...
func schema_pkg_apis_sotaria_v1alpha1_ProjectList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("k8s.io/sample-apiserver/pkg/apis/sotaria/v1alpha1.Project"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "k8s.io/sample-apiserver/pkg/apis/sotaria/v1alpha1.Project"},
	}
}
